    ...
    <div>
      ...
      >
        <div className="section-reveal flex flex-col justify-center bg-[var(--color-dark)] px-4 py-14 sm:px-10 sm:py-20 lg:px-14 lg:py-24">
          ...
          <div className="mt-10 flex w-full max-w-md flex-col gap-3 sm:max-w-none sm:flex-row sm:items-center sm:gap-4">
            <ContactTrigger className="btn-rust w-full sm:w-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-on-dark)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-dark)]">
              Contact us
            </ContactTrigger>
            <Link
              href="/services"
              className="btn-outline-light w-full sm:w-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-on-dark)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-dark)]"
            >
              Programs
            </Link>
          </div>
      ...
      <section className="section-reveal bg-[var(--color-sand)] py-10 sm:py-12">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:grid-cols-2 sm:gap-0 sm:px-6 lg:px-10">
          <div className="sm:border-r sm:border-[var(--color-dark)]/15 sm:pr-10">
            <p className="label-caps">Locally rooted</p>
            <p className="mt-2 heading-section text-[var(--color-dark)] sm:text-3xl">
              {siteConfig.familyOwned}
            </p>
          </div>
          <div className="sm:pl-10">
            <p className="label-caps">Service area</p>
            <p className="mt-2 text-lg normal-case leading-relaxed tracking-normal text-[var(--color-muted)]">
